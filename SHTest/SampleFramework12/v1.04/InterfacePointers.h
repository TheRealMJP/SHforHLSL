...
typedef Microsoft::WRL::ComPtr<ID3D12SDKConfiguration1> ID3D12SDKConfiguration1Ptr;
typedef Microsoft::WRL::ComPtr<ID3D12DeviceFactory> ID3D12DeviceFactoryPtr;
...
typedef Microsoft::WRL::ComPtr<ID3D12InfoQueue1> ID3D12InfoQueue1Ptr;
